...
C.h=new L.qh()
C.c=new P.qn()
C.a5=new X.h4("core-header-panel",null)
C.A=new P.a3(0)
C.a9=function(hooks) {
...
init.typeToInterceptorMap=[C.f,W.B,{},C.o,Y.d4,{created:Y.kR},C.S,T.ef,{created:T.l9},C.U,A.dp,{created:A.n2}];(function(a){for(var z=0;z<a.length;){var y=a[z++]
var x=a[z++]
var w=a[z++]
